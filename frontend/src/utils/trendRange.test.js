...
describe('overviewTrendRange', () => {
    it('anchors the chart to the latest actual transaction date', () => {
        expect(overviewTrendRange([
            { date: '2026-01-12' },
            { date: '2026-01-29' },
        ], new Date('2026-08-09T12:00:00Z'))).toEqual({
    ...
    it('uses today when there is no transaction history', () => {
        expect(overviewTrendRange([], new Date('2026-08-09T12:00:00Z'))).toEqual({
    ...
    it('ignores invalid and future transaction dates', () => {
        expect(overviewTrendRange([
            ...
            { date: '2026-09-01' },
            { date: '2026-08-05' },
        ], new Date('2026-08-09T12:00:00Z')).endDate).toBe('2026-08-05');
    });
});
