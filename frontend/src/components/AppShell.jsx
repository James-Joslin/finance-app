        ...
        <div className="app-shell">
            <aside className={'side-rail ' + (mobileMenu ? 'mobile-open' : '')}>
                <div className="rail-top">
                    <FinovaLogo />
                    <button
                        className="icon-button mobile-rail-close"
                ...
                <div className="household-profile">
                    ...
                    <span>
                        <strong>
                            {dashboard.data?.householdName || 'My Household'}
                        </strong>
                        <small>{profileName || 'Private workspace'}</small>
                    </span>
                </div>
            </aside>
            ...
            <main className="app-main">
                <header className="topbar">
                    ...
                    <div className="page-heading">
                        <img
                            className="page-heading-accent"
                            src={staticAssetUrl(
                                `decor/decor_wave_02${resolved === 'dark' ? '_night' : ''}.png`
                            )}
                            alt=""
                            aria-hidden="true"
                        />
                    ...
                    <div className="topbar-actions">
                        ...
                        <div className="popover-wrap">
                            ...
                            >
                                <Bell />
                                {dashboard.data?.alerts?.length > 0 && <span />}
                            </button>
                            {alertsOpen && (
                                <Alerts
    ...
    return (
        <div className="popover alerts-popover">
            <div className="popover-title">
                <strong>Household alerts</strong>
            ...
            {alerts.length === 0 ? (
                <p className="popover-empty">
                    Everything looks calm. Finova will flag buffers, budgets,
                    and dates here.
                </p>
            ) : (
                alerts.map((alert) => (
...
function CommandSearch({ open, onClose }) {
    ...
    useEffect(() => {
        ...
        const timer = window.setTimeout(async () => {
            setLoading(true);
            try {
                setResults(await searchFinova(query));
            } catch {
                setResults([]);
            } finally {
                setLoading(false);
            ...
            >
                <div className="command-input">
                    ...
                    <input
                        ...
                        placeholder="Search transactions, goals, accounts and plans…"
                    />
                    <kbd>Esc</kbd>
                </div>
                <div className="command-results">
                    {query.length < 2 && (
                        <p>
                            Type at least two characters to search your Finova
                            workspace.
                        </p>
                    )}
