...
export const goalVisuals = definitions.map(
...
export function GoalVisual({
    ...
    return (
        <div
            ...
            style={{
                '--goal-primary': palette[0],
                '--goal-secondary': palette[1],
            }}
            role="img"
            aria-label={label || definition.title}
        >
            <svg
                className="goal-vector-art"
                viewBox="0 0 400 120"
                preserveAspectRatio="xMidYMid slice"
                aria-hidden="true"
            >
                <path
                    d="M-18 104 C58 49 121 132 205 77 C278 29 331 111 418 54 V138 H-18Z"
                    fill="var(--goal-secondary)"
                    opacity=".14"
                />
                <path
                    d="M-18 100 C58 45 121 128 205 73 C278 25 331 107 418 50"
                    fill="none"
                    stroke="var(--goal-primary)"
                    strokeWidth="2"
                    strokeOpacity=".42"
            ...
            <span className="goal-icon-orbit">
